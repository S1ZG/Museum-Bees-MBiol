...
file_path_to_tas_25km.nc <- "Data/dap.ceda.ac.uk/badc/ukmo-hadobs/data/insitu/MOHC/HadOBS/HadUK-Grid/v1.3.1.ceda/25km/tas/mon/v20250415/"
file_path_to_tasmax_25km.nc <- "Data/dap.ceda.ac.uk/badc/ukmo-hadobs/data/insitu/MOHC/HadOBS/HadUK-Grid/v1.3.1.ceda/25km/tasmax/mon/v20250415/" 


# Read and stack tas
tas_files <- list.files(file_path_to_tas_25km.nc,full.names = TRUE)[-1] ## dropping 'index'
...
tasmax_files <- list.files(file_path_to_tasmax_25km.nc,full.names = TRUE)[-1]
...
# Save as .csv
#write.csv(bees_temps, "Data/17_03_26_bees_temps_25km.csv", row.names = FALSE)
